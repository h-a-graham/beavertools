...
RivOtter_FeedSigns <- Ott_FSS_pre15 %>%
  bind_rows(Ott_FSS_15_16, Ott_FSS_16_17, Ott_FSS_17_18, Ott_FSS_18_19, Ott_FSS_19_20) %>%
  ...
  mutate(SurveySeason = fct_relevel(SurveySeason, 'Pre 2015', '2015 - 2016', '2016 - 2017', '2017 - 2018', '2018 - 2019', '2019 - 2020')) %>%
