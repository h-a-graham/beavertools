...
# pre 15
Dwell_Pre15 <- read_sf('data-raw/Otter_survey_raw/Dam_Dwelling.gpkg', layer='Dwelling_Pre15') %>%
  prep_data(., 'Dwelling', 'Pre 2015')

# Winter 15 - 16
Dwell_15_16 <- read_sf('data-raw/Otter_survey_raw/Dam_Dwelling.gpkg', layer='Dwelling_15_16') %>%
  prep_data(., 'Dwelling', '2015 - 2016')

Dam_15_16 <- read_sf('data-raw/Otter_survey_raw/Dam_Dwelling.gpkg', layer='Dam_15_16') %>%
  prep_data(., 'Dam', '2015 - 2016')

# Winter 16 -17
Dwell_16_17 <- read_sf('data-raw/Otter_survey_raw/Dam_Dwelling.gpkg', layer='Dwelling_16_17') %>%
  prep_data(., 'Dwelling', '2016 - 2017')

Dam_16_17 <- read_sf('data-raw/Otter_survey_raw/Dam_Dwelling.gpkg', layer='Dam_16_17') %>%
  prep_data(., 'Dam', '2016 - 2017')

# Winter 17 - 18
Dwell_17_18 <- read_sf('data-raw/Otter_survey_raw/Dam_Dwelling.gpkg', layer='Dwelling_17_18') %>%
  prep_data(., 'Dwelling', '2017 - 2018')

Dam_17_18 <- read_sf('data-raw/Otter_survey_raw/Dam_Dwelling.gpkg', layer='Dam_17_18') %>%
  prep_data(., 'Dam', '2017 - 2018')

# Winter 18 - 19
Dwell_18_19 <- read_sf('data-raw/Otter_survey_raw/Dam_Dwelling.gpkg', layer='Dwelling_18_19') %>%
  prep_data(., 'Dwelling', '2018 - 2019')

Dam_18_19 <- read_sf('data-raw/Otter_survey_raw/Dam_Dwelling.gpkg', layer='Dam_18_19') %>%
  prep_data(., 'Dam', '2018 - 2019')

# Witer 19 - 20
Dwell_19_20 <- read_sf('data-raw/Otter_survey_raw/Dam_Dwelling.gpkg', layer='Dwelling_19_20') %>%
  prep_data(., 'Dwelling', '2019 - 2020')

Dam_19_20 <- read_sf('data-raw/Otter_survey_raw/Dam_Dwelling.gpkg', layer='Dam_19_20') %>%
...
# Check sf dataframe
ggplot() +
  ggspatial::annotation_map_tile(type = 'osmgrayscale', zoomin = 0, alpha = 0.8) +
  layer_spatial(RivOtter_OtherSigns, aes(colour=SignType) ,alpha = 0.7) +
  coord_sf(crs = sf::st_crs(RivOtter_OtherSigns), datum =  sf::st_crs(RivOtter_OtherSigns)) +
