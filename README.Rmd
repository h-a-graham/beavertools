...
![Territory Capacity Scenarios](R_Otter_workflow/2_Territory_simulations/plots/Lower_Upper_Capacity_maps.jpg)


Now that we know the territory capacity we can begin to model the population dynamics of the catchment. For the full code workflow check out [beavertools/R_Otter_workflow](beavertools/R_Otter_workflow).
...
![Population Growth curve](R_Otter_workflow/3_Pop_expansion_predictions/plots/TerritoryPredictionc.png)
